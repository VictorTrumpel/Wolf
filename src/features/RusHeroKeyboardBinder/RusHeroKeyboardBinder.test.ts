...
describe('Спецификация компонента RusHeroKeyboardBinder', () => {
  ...
  test('Биндится клавиша W под движение наверх', () => {
    new RusHeroKeyboardBinder({} as unknown as IRusHeroState, MockKeybordHandlerBinder)

    expect(MockKeybordHandlerBinder.bindMoveTopKey).toBeCalledTimes(1)
    expect(MockKeybordHandlerBinder.bindMoveTopKey).toBeCalledWith(Input.Keyboard.KeyCodes.W)
  })
  test('Биндится клавиша S под движение вниз', () => {
    new RusHeroKeyboardBinder({} as unknown as IRusHeroState, MockKeybordHandlerBinder)

    expect(MockKeybordHandlerBinder.bindMoveBottomKey).toBeCalledTimes(1)
    expect(MockKeybordHandlerBinder.bindMoveBottomKey).toBeCalledWith(Input.Keyboard.KeyCodes.S)
  })
  test('Биндится клавиша D под движение вправо', () => {
    new RusHeroKeyboardBinder({} as unknown as IRusHeroState, MockKeybordHandlerBinder)

    expect(MockKeybordHandlerBinder.bindMoveRightKey).toBeCalledTimes(1)
    expect(MockKeybordHandlerBinder.bindMoveRightKey).toBeCalledWith(Input.Keyboard.KeyCodes.D)
  })
  test('Биндится клавиша A под движение влево', () => {
    new RusHeroKeyboardBinder({} as unknown as IRusHeroState, MockKeybordHandlerBinder)

    expect(MockKeybordHandlerBinder.bindMoveLeftKey).toBeCalledTimes(1)
    expect(MockKeybordHandlerBinder.bindMoveLeftKey).toBeCalledWith(Input.Keyboard.KeyCodes.A)
  })
  ...
  test("Биндится команда 'движения вверх'", () => {
    const hero = {} as unknown as IRusHeroState
    new RusHeroKeyboardBinder(hero, MockKeybordHandlerBinder)
    const MockMoveHeroTopCommand = MoveHeroTopCommand as ReturnType<typeof vi.fn>
    ...
    expect(MockKeybordHandlerBinder.bindMoveTopCommand).toBeCalledWith(topCommand)
  })
  test("Биндится команда 'движения вниз'", () => {
    const hero = {} as unknown as IRusHeroState
    new RusHeroKeyboardBinder(hero, MockKeybordHandlerBinder)
    const MoveHeroBottomCommand = MoveHeroTopCommand as ReturnType<typeof vi.fn>
    ...
    expect(MockKeybordHandlerBinder.bindMoveBottomCommand).toBeCalledWith(bottomCommand)
  })
  test("Биндится команда 'остановить движение по вертикали'", () => {
    const hero = {} as unknown as IRusHeroState
    new RusHeroKeyboardBinder(hero, MockKeybordHandlerBinder)
    const MoveStopMoveYHeroCommand = StopMoveYHeroCommand as ReturnType<typeof vi.fn>
    ...
    expect(MockKeybordHandlerBinder.bindStopMoveYCommand).toBeCalledWith(stopYCommand)
  })
  test("Биндится команда 'движение влево'", () => {
    ...
    expect(MockKeybordHandlerBinder.bindMoveLeftCommand).toBeCalledWith(moveLeftCommand)
  })
  test("Биндится команда 'движение вправо'", () => {
    ...
    expect(MockKeybordHandlerBinder.bindMoveRightCommand).toBeCalledWith(moveRightCommand)
  })
  test("Биндится команда 'остановить движение по горизонтали'", () => {
    ...
    expect(MockKeybordHandlerBinder.bindStopMoveXCommand).toBeCalledWith(stopMoveXCommand)
  })
  test("Биндится команда 'остановить движение'", () => {
    ...
    expect(MockKeybordHandlerBinder.bindStopMoveCommand).toBeCalledWith(stopMoveXCommand)
  })
  test('Метод getKeyboard() возвращает инстанс клавиатуры', () => {
    const hero = {} as unknown as IRusHeroState
    const keyboardHandler = new RusHeroKeyboardBinder(hero, MockKeybordHandlerBinder)
