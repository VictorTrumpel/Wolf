...
describe('Спецификация класса MovingHeroState', () => {
  ...
  `, () => {
    ...
    const movingHeroState = new MovingHeroState(MockHeroContext as unknown as RusHeroContext)
  ...
  test('При вызове метода stopMovingX() на спрайте вызывается метод stopMovingX()', () => {
    ...
    const movingHeroState = new MovingHeroState(MockContext as unknown as RusHeroContext)
